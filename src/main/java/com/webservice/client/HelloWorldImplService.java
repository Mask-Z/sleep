 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://server.webservice.com/", wsdlLocation = "http://localhost:8080/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://server.webservice.com/", "HelloWorldImplService");
    ...
    public HelloWorldImpl getHelloWorldImplPort() {
        return super.getPort(new QName("http://server.webservice.com/", "HelloWorldImplPort"), HelloWorldImpl.class);
    }
    ...
    public HelloWorldImpl getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.webservice.com/", "HelloWorldImplPort"), HelloWorldImpl.class, features);
    }
